...
public class IccPhoneBookOperationException extends RuntimeException {
    ...
    public static final int OVER_AAS_MAX_LENGTH = -10;
    public static final int AAS_CAPACITY_FULL = -11;
    /* @} */
    /* SPRD: add for bug 540015 {@ */
    public static final int GRP_RECORD_MAX_LENGTH = -12;
    /* @} */
