...
public class StorageUtil {
    ...
    public long getInternalAvailableSpace() {
        ...
        String spath = Environment.getInternalStoragePath().getAbsolutePath();
        String state = null;
    ...
    public Map<String, String> supportedRootDirectory() {
        ...
        if (!isStoragepathUnified) {
            String internal_state = Environment.getInternalStoragePathState(), external_state = Environment
            ...
            internal = (internal_mounted ? Environment.getInternalStoragePath()
                    .getAbsolutePath() : null);
            external = (external_mounted ? Environment.getExternalStoragePath()
                    .getAbsolutePath() : null);
            ...
            if (Environment.getInternalStoragePath().getAbsolutePath()
                    .equals(storagePath)) {
                internal = storagePath;
            } else if (Environment.getExternalStoragePath().getAbsolutePath()
                    .equals(storagePath)) {
